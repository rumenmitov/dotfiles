...
_keybinds =
    ...
    , ("M-r",     spawn "dmenu_run -i -l 4 -sb \\#000000 -sf \\#ff79c6")
    , ("M-.",     spawn "cat ~/.local/share/emojis/emojis.csv | dmenu -i -l 4 -sb \\#000000 -sf \\#ff79c6 | awk '{print $1}' | tr -d \"\n\" | xclip -selection c")
    , ("M-,",     spawn "cat ~/.local/share/emojis/math.csv | dmenu -i -l 4 -sb \\#000000 -sf \\#ff79c6 | awk '{print $1}' | tr -d \"\n\" | xclip -selection c")
    , ("M-S-v",   spawn "greenclip print | grep . | dmenu -i -l 4 -sb \\#000000 -sf \\#ff79c6 | xargs -r -d'\n' -I '{}' greenclip print '{}'")
    , ("M-p",     spawn "passmenu -i -l 4 -sb \\#000000 -sf \\#ff79c6")
